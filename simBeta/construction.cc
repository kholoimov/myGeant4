...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
  ...
  G4Box *solidRadiator = new G4Box("solidRadiator", 0.4*m,0.4*m, 5*mm);

  G4LogicalVolume *logicRadiator = new G4LogicalVolume(solidRadiator, Aluminium, "logicalRadiator");
  G4VPhysicalVolume *physRadiator = new G4PVPlacement(0,G4ThreeVector(0.,0.,-0.44*m), logicRadiator, "physRadiator",logicWorld, false, 0, true);
